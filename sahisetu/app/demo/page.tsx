...
const profiles = [
  {
    ...
    benefit: "Spot expiry and preparation gaps early.",
    benefitHi: "समाप्ति और तैयारी की कमियाँ जल्दी देखें।",
    href: "/dashboard",
    icon: "⌛",
  ...
  },
  {
    ...
    benefit: "Catch address-entry differences before proceeding.",
    benefitHi: "आगे बढ़ने से पहले पता-प्रविष्टि अंतर पकड़ें।",
  ...
  },
  {
    ...
    benefit: "Verify an unresolved payment before considering another payment.",
    benefitHi: "दूसरे भुगतान पर विचार करने से पहले लंबित भुगतान जाँचें।",
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {profiles.map((profile) => (
              <article key={profile.name} className={`flex flex-col rounded-3xl border p-6 ${profile.tone}`}>
                ...
                <p className="mt-4 rounded-xl bg-[#e5f5e7] p-3 text-xs font-semibold leading-5 text-[#246238]">
                  <span className="block text-[10px] font-bold uppercase tracking-[0.12em] text-[#31804a]">
                    {hindi ? "SahiSetu मदद" : "SahiSetu helps"}
                  </span>
                  <span className="mt-1 block">{hindi ? profile.benefitHi : profile.benefit}</span>
                </p>
                <Link
                  href={profile.href}
